...
void Natives_OnPluginStart()
{
    ...
    g_Forward.m_MapDataInit         = new GlobalForward("OnMapDataInit",          ET_Ignore);
...
void Call_MapDataInit(any cell)
{
    Call_StartForward(g_Forward.m_MapDataInit);
    Call_PushCell(cell);
    Call_Finish();
}
